原文链接：[阿里技术专家详解 DDD 系列](https://mp.weixin.qq.com/s?__biz=MzAxNDEwNjk5OQ==&mid=2650404060&idx=1&sn=cacf40d19528f6c2d9fd165151d6e8b4&chksm=83953cc4b4e2b5d2bd4426e0d2103f2e95715b682f3b7ff333dbb123eaa79d3e5ad24f64beac&mpshare=1&scene=1&srcid=0603X9M5325qOXuImmX2uLnk&sharer_sharetime=1685776975025&sharer_shareid=fd8ca462f418fde1153c154e83956699#rd)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261800493.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261802962.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261802806.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261802495.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261802498.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261804486.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261804653.png)

然后通过重新编排后该图变为：

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261804878.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805589.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805465.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805742.png)

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805139.png)

#### 3.1.1 - Types 模块

Types模块是保存可以对外暴露的Domain Primitives的地方。Domain Primitives因为是无状态的逻辑，可以对外暴露，所以经常被包含在对外的API接口中，需要单独成为模块。Types模块不依赖任何类库，纯 POJO 。

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805343.png)

#### 3.1.2 - Domain 模块

Domain 模块是核心业务逻辑的集中地，包含有状态的Entity、领域服务Domain Service、以及各种外部依赖的接口类（如Repository、ACL、中间件等。Domain模块仅依赖Types模块，也是纯 POJO 。

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261805510.png)

#### 3.1.3 - Application模块

Application模块主要包含Application Service和一些相关的类。Application模块依赖Domain模块。还是不依赖任何框架，纯POJO。

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261806702.png)
...
![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261806818.png)

#### 3.1.5 - Web模块

Web模块包含Controller等相关代码。如果用SpringMVC则需要依赖Spring。

![img](https://run-notes.oss-cn-beijing.aliyuncs.com/notes/202308261806558.png)
