...
将上面的`main.go`文件编译执行，然后使用浏览器访问 `http://127.0.0.1:9090`：

![image-20220508210335873](C:\Users\AruNi、\AppData\Roaming\Typora\typora-user-images\image-20220508210335873.png)
...
![image-20220508213729122](C:\Users\AruNi、\AppData\Roaming\Typora\typora-user-images\image-20220508213729122.png)
